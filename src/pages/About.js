...
import '../components/Statics/styles/About.css'
// Componentes:
import Navbar from '../components/Navbar';
import InfoSection from '../components/InfoSection';
import Footer from '../components/Footer';
// Recursos:
import img1 from '../components/Statics/img/1.png';
import img2 from '../components/Statics/img/3.png';
import img3 from '../components/Statics/img/2.png';
import img4 from '../components/Statics/img/4.png';
...
function About() {
  const info =[
    ...
    {pregunta: '¿Cómo nos sustentamos?',
     info:'Zombie ipsum reversus ab viral inferno, nam rick grimes malum cerebro. De carne lumbering animata corpora quaeritis. Summus brains sit​​, morbo vel maleficia? De apocalypsi gorger omero undead survivor dictum mauris. Hi mindless mortuis soulless creaturas, imo evil stalking monstra adventus resi dentevil vultus comedat cerebella viventium. Qui animated corpse, cricket bat max brucks terribilem incessu zomby. The voodoo sacerdos flesh eater, suscitat mortuos comedere carnem virus. Zonbi tattered for solum oculi eorum defunctis go lum cerebro. Nescio brains an Undead zombies. Sicut malus putrid voodoo horror. Nigh tofth eliv ingdead. Cum horribilem walking dead resurgere de crazed sepulcris creaturis, zombie sicut de grave feeding iride et serpens. Pestilentia, shaun ofthe dead scythe animated corpses ipsa screams. Pestilentia est plague haec decaying ambulabat mortuos. Sicut zeder apathetic malus voodoo. Aenean a dolor plan et terror soulless vulnerum contagium accedunt, mortui iam vivam unlife. Qui tardius moveri, brid eof reanimator sed in magna copia sint terribiles undeath legionis. Alii missing oculis aliorum sicut serpere crabs nostram. Putridi braindead odores kill and.'
    },
    {pregunta: '¿Cómo invertimos nuestros recursos?',
     info:'Zombie ipsum reversus ab viral inferno, nam rick grimes malum cerebro. De carne lumbering animata corpora quaeritis. Summus brains sit​​, morbo vel maleficia? De apocalypsi gorger omero undead survivor dictum mauris. Hi mindless mortuis soulless creaturas, imo evil stalking monstra adventus resi dentevil vultus comedat cerebella viventium. Qui animated corpse, cricket bat max brucks terribilem incessu zomby. The voodoo sacerdos flesh eater, suscitat mortuos comedere carnem virus. Zonbi tattered for solum oculi eorum defunctis go lum cerebro. Nescio brains an Undead zombies. Sicut malus putrid voodoo horror. Nigh tofth eliv ingdead. Cum horribilem walking dead resurgere de crazed sepulcris creaturis, zombie sicut de grave feeding iride et serpens. Pestilentia, shaun ofthe dead scythe animated corpses ipsa screams. Pestilentia est plague haec decaying ambulabat mortuos. Sicut zeder apathetic malus voodoo. Aenean a dolor plan et terror soulless vulnerum contagium accedunt, mortui iam vivam unlife. Qui tardius moveri, brid eof reanimator sed in magna copia sint terribiles undeath legionis. Alii missing oculis aliorum sicut serpere crabs nostram. Putridi braindead odores kill and.'
    },
  ];
  ...
  return (
    <React.Fragment>
      ...
      <div className='about_image'>
        <figure>
          <img src={img1} alt="Imagen de Nosotros" className='info_img'/>
        </figure>
      </div>
      <InfoSection titulo={info[0].pregunta} descripcion={info[0].info}/>
      <figure className='right'>
          <img src={img2} alt="Imagen de Nosotros" className='info_img'/>
        </figure>
      <InfoSection titulo={info[1].pregunta} descripcion={info[1].info}/>
      <figure id='img3'>
          <img src={img3} alt="Imagen de Nosotros"/>
        </figure>
      <InfoSection titulo={info[2].pregunta} descripcion={info[2].info}/>
      <figure className='right'>
          <img src={img4} alt="Imagen de Nosotros" className='info_img'/>
        </figure>
      <InfoSection titulo={info[3].pregunta} descripcion={info[3].info}/>
      <Footer/>
    </React.Fragment>
  );
}
